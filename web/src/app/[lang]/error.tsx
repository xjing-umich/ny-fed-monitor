    ...
    <div className="mx-auto flex max-w-xl flex-col items-start gap-5 py-20 sm:py-28">
      ...
      <div className="mt-1 flex flex-wrap items-center gap-3">
        <button
          type="button"
          onClick={retry}
          className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium bg-[var(--tt-accent)] text-white transition-opacity hover:opacity-90"
        >
          {t.retry}
        </button>
        <Link
