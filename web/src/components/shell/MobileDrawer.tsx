            ...
            {(["zh", "en"] as const).map((l) => {
              ...
              return (
                <Link
                  ...
                  className={[
                    "px-2.5 py-1 rounded text-[11px] font-mono uppercase tracking-wider transition-colors no-underline",
                    active
                      ...
                      : "text-[var(--tt-muted)] hover:text-[var(--tt-text)] border border-[var(--tt-border)]",
                  ].join(" ")}
                >
                  {l}
                </Link>
