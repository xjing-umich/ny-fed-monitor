    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center justify-center rounded-md px-3 py-2 text-sm font-medium bg-[var(--tt-accent)] text-white hover:opacity-90 transition-opacity disabled:opacity-60"
        >
          {status === "sending" ? (
            c.subscribing
          ) : (
